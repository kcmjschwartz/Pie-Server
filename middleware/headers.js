...
* Cross-Origin Resource Sharing
    - mechanism that uses additional HTTP headers to tell browers to give a web application running at one origin acces to selected resources from a different origin.

    1: a response header that tells the browser to allow code from any origin.
    2: a response that specifies the method or methods allowed when accessing the resources to a preflight request.
...
* Preflight Requests:
    ...
    - automatically issed by a browser.
