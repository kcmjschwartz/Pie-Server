...
const router = require('../controllers/piecontroller');
...
?  We call the .define() method. This is a sequelize method that will map model properties

! Postgres makes the table names plural so we use singular in code.
*/